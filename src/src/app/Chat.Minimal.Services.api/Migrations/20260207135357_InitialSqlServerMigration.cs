        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TokenLimit = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    TokensUsed = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AiInteractionLogs_AiConfigs_AiConfigId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AiInteractionLogs_AiConfigId",
                table: "AiInteractionLogs",
                column: "AiConfigId");

            migrationBuilder.CreateIndex(
                name: "IX_AiInteractionLogs_ConversationId",
                table: "AiInteractionLogs",
                column: "ConversationId");

            migrationBuilder.CreateIndex(
                name: "IX_AiInteractionLogs_Timestamp",
                table: "AiInteractionLogs",
                column: "Timestamp");
